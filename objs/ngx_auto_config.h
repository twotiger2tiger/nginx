#define NGX_CONFIGURE " --prefix=/home/liuzhentao/nginx/nginx-1.13.1 --user=nginx --group=nginx --with-http_ssl_module --with-http_stub_status_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/liuzhentao/nginx/nginx-1.13.1/"
#endif
